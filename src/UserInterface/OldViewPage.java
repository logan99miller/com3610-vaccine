...
public class OldViewPage extends Page {
    ...
    public OldViewPage(VaccineSystem vaccineSystem, MainPage mainPage, String title, String[] headings, String[] columnNames,
    ...
    private void addReferenceButtonActionListener(HashMap<String, Object> reference, String where) {
        ...
        OldViewPage viewPage = new OldViewPage(
