...
import UserInterface.OldViewPage;

import javax.swing.*;
import java.util.HashMap;
import java.util.Map;

public class OldSelectViewPage extends SelectPage {
    ...
    public OldSelectViewPage(VaccineSystem vaccineSystem, MainPage mainPage) {
        super(vaccineSystem, mainPage, "view");
        createMaps();
        addButtons(createPages());
    }

    private OldViewPage createViewPage(HashMap<String, Object> map, String title) {
        OldViewPage viewPage;
    ...
    private void addButtons(HashMap<String, HashMap<String, Object>> pages) {
        for (Map.Entry<String, HashMap<String, Object>> set : pages.entrySet()) {
            ...
            button.addActionListener(e -> {
                OldViewPage viewPage = createViewPage(set.getValue(), button.getText());
