/**
 * Calculates travel time and distance measurements used in the automation of vaccine deliveries
 */
package Automation;
...
public class Distance {
    ...
    /**
     * Gets the travel time for the given distance, speed stored as a constant in method.
     * @param distance distance to compute time for
     * @return travel time in seconds
     */
    public static int getTravelTime(double distance) {
        final float SPEED_KMPH = 55;
        final float SPEED_KMPS = SPEED_KMPH / (60 * 60); // KM / second
    ...
    /**
     * Applies the Haversine formula to calculate the shortest distance over the earth's surface. Av oids the use of cosine
     * formula as it is unreliable for small distances
     *
     * @return the shortest distance in km
     */
